...
const Weather = () => {
  ...
  return (
    <div className="w-full h-screen bg-gradientBg bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4 lg:px-0">
      {errorMsg && (
        <div className="w-full max-w-[100vw] lg:max-w-[450px] bg-[#25C3FF] text-white top-2 lg:top-10 rounded-full p-4 capitalize my-2">{`${errorMsg.response.data.message}`}</div>
      )}
      <form
        className={`${
          animate ? "animate-shake" : "animate-none"
        } h-16 bg-black/50 w-full max-w-[450px] rounded-full backdrop-blur-[32px] mb-8`}
      >
      ...
      {/* card */}
      <div className="w-full max-w-[480px] bg-black/40 min-h-[590px] text-white rounded-[30px] backdrop-blur-[32px] py-12 px-6">
        {loading ? (
          ...
          <div>
            ...
            <div className="my-20">
              <div className="flex justify-center items-center">
                {/* temp */}
                <div className="text-[145px] leading-none font-light">
